...
import { AlertCircleIcon, Component, HashIcon, LockIcon, User, UsersIcon, XIcon } from "lucide-react";
...
const CreateChannelModal = ({ isOpen, onClose }) => {
    ...
    //fetch user for memeber selection
    useEffect(() => {
    ...
    const validateChannelName = (name) => {
        ...
        if (name.length < 3) return "channel Name must be at atelst 3 Character ";
        if (name.length > 22) return "Channel name must be less than 22 character";
